...
<style>
    ...
    *{
    ...
    .banner{
        ...
        background-image: url("{{ asset('Zedla_image/ZW3.jpg') }}");
        ...
        <div class="Fix">
            ...
            <div class="section">
                <div class="artical">
                    ...
                    <p>&emsp;&emsp;海拉魯王國(日語：ハイラル王国；英語：Kingdom of Hyrule)，通常簡稱為『海拉魯』，是薩爾達傳說系列最具代表性，也是系列世界觀中歷史最悠久的主權國家。儘管在系列的歷史中，海拉魯王國因為各種因素，導致領地、人口組成與政治中樞都曾有不同的變化，但海拉魯王國繼承了最古老的神話史，其王族也是神話人物的血脈後裔，因此又有著『神之國』的美稱。海拉魯王國是系列多數作品中登場的架空國家，國民以海利亞人為主，並由三角神力與洛夫特飛鳥符號所組成的符號為國徽，首都稱為海拉魯城，但歷代作的海拉魯城造型還是因為地形地貌及位置而有所不同。海拉魯王國有一個既定傳統，凡王室公主皆視為海利亞女神之血繼承者以薩爾達命名，有些版本裡薩爾達公主直接以國家統治者的身份登場，另外領土內一些亞人種族如摩格瑪族、卓拉族等會自成一國。不過從海利亞人還能跟他們和平共處來看，海拉魯王國對這些部落自治很寬容，也對應了禦天之劍劇情設定(在上古戰爭中，海利亞女神與亞人種族組成聯合軍討伐魔族之主)。</p>
                    </div>
                    <div class="Ak"></div>
                </div>
            </div>
